 ...
 * @Date: 2021-09-03 16:37:24
 * @LastEditors: Yanzhao.Zhang
 * @LastEditTime: 2022-03-22 23:09:16
 * @Description: css动画效果
-->
<template>
  <div class="g-container">
    <p v-for="item in pNum" :key="item"></p>
  </div>
</template>
...
$str: '
ぁぃぅぇぉかきくけこんさしすせそた◁▣▤▥▦▧♂♀♥☻►◄▧▨♦ちつってとゐなにぬねのはひふへほゑまみむめもゃゅょゎをァィゥヴェォカヵキクケ
ヶコサシスセソタチツッテトヰンナニヌネノハヒフヘホヱマミムメモャュョヮヲㄅㄉㄓㄚㄞㄢㄦㄆㄊㄍㄐㄔㄗㄧㄛㄟㄣㄇㄋㄎㄑㄕㄘㄨㄜㄠㄤㄈㄏ
ㄒㄖㄙㄩㄝㄡㄥabcdefghigklmnopqrstuvwxyz123456789%@#$<>^&*_+
';
